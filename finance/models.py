...
class punishments(models.Model):
    ...
    punishment_job_title_id = models.ForeignKey('job_management.job_titles', on_delete=models.CASCADE, related_name="+", null=True, blank=True)
    punishment_amount = models.IntegerField()
    punishments_cause = models.TextField(null=True, default=None, blank=True)
    punishment_date = models.DateField(null=True, default=None, blank=True)
...
class rewards(models.Model):
    ...
    reward_job_title_id = models.ForeignKey('job_management.job_titles', on_delete=models.CASCADE, related_name="+", null=True, blank=True)
    reward_amount = models.IntegerField()
    reward_cause = models.TextField(null=True, default=None, blank=True)
    reward_date = models.DateField(null=True, default=None, blank=True)
