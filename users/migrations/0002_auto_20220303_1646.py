# Generated by Django 2.2.5 on 2022-03-03 13:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='users',
            name='email',
            field=models.EmailField(default='anyemail', max_length=60, unique=True, verbose_name='email'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='users',
        ...
        migrations.AddField(
            model_name='users',
            name='password',
            field=models.CharField(default='passi', max_length=128, verbose_name='password'),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='users',
